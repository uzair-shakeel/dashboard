    ...
    <div className="w-full h-screen lg:flex">
      ...
      <div className="w-full h-screen relative">
        ...
        <div className="overflow-x-auto w-full mx-auto pb-5">
          <table className="min-w-[1200px] lg:min-w-full border-b border-[#DBDBDB]">
            ...
            <tbody>
              <tr className="text-[14px]">
                ...
                <td
                  className="px-4 py-1 border border-[#DBDBDB] hover:underline underline-offset-2 cursor-pointer"
          ...
          {/* Panel */}
          {isPopupOpen && (
            <div className="bg-white shadow-2xl border-l border-stone-300  md:w-[50%] h-[100vh] min-h-screen absolute top-0 bottom-0 right-0">
              <div className="relative ">
                {/* Close Button */}
                <button
                  onClick={closePopup}
                  className="absolute m-2 sm:m-4 lg:right-3  right-14 top-3 border rounded-full z-50 text-xl p-1 hover:shadow-lg transition duration-300"
                >
                  <RxCross2 />
                </button>
                <Panel />
