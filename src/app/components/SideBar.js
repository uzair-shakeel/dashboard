...
const SideBar = () => {
  return (
    <div className='border-r border-[#E8E8E8] h-full p-3 w-full relative'>
      ...
      {/* Search & Inbox & Tasks */}
      <div className='mt-[30px] flex flex-col gap-[7px] ml-1'>
        <div className='flex items-center gap-[10px] text-[#161616] text-[14px] leading-[17px] font-normal'>
          <Image src='/assets/search.svg' alt='Search' width={15} height={15} className='cursor-pointer' />
          Search
        </div>
        <div className='flex items-center justify-between gap-[10px] text-[#161616] text-[14px] leading-[17px] font-normal'>
      ...
      <div className='mt-[30px] flex flex-col gap-[7px] '>
        <div className='flex items-center gap-[10px] bg-[#F3F3F3] rounded-lg h-[29px] px-[5px] text-black text-[14px] leading-[17px] font-medium'>
          <Image src='/assets/deals.svg' alt='Search' width={15} height={15} className='cursor-pointer' />
          Deals
        </div>

        <div className='ml-1 flex items-center justify-between gap-[10px] text-[#161616] text-[14px] leading-[17px] font-normal'>
          <div className='flex items-center gap-[10px]'>
        ...
        <div className='ml-1 flex items-center gap-[10px] text-[#161616] text-[14px] leading-[17px] font-normal'>
      ...
      {/* Collections */}
      <div className='mt-[30px] flex flex-col gap-[7px] ml-1'>
        <div className='flex items-center justify-between gap-[10px] text-[#656565] text-[14px] leading-[17px] font-normal'>
          Collections
          <Image src='/assets/dots.svg' alt='Search' width={15} height={15} className='cursor-pointer' />
        </div>

        <div className='mt-[5px] flex items-center gap-[10px] text-[#161616] text-[14px] leading-[17px] font-normal cursor-pointer'>
      ...
      <div className='mt-[250px]'>
        ...
        <div>
          ...
          <div className='flex items-center justify-between pt-3 pb-2'>
            ...
            <Image src='/assets/star.svg' alt='Logo' width={28} height={28} className='cursor-pointer'/>
